<template>
  <main class="text-center justify-center items-center">
    <div class="flex flex-col items-center justify-center">
      <!-- Your SVG and content here -->
      <svg
        class="rocketAnimation animate-smoke mt-8 sm:mt-24 max-w-[200px] sm:max-w-[390px] flex-shrink-0"
        viewBox="0 0 508 268"
        aria-hidden="true"
      >
    ...
    <h1 class="text-2xl sm:text-4xl mt-4">Success installing django-fullstack!</h1>
